...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az301template/master/az-301-04-03-a-code.zip", (Get-Location).Path + "\az-301-04-03-a-code.zip")

$zipfile = $shell_app.Namespace((Get-Location).Path + "\az-301-04-03-a-code.zip")
