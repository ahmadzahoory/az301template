...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ahmadzahoory/az301template/master/website-code-M01-01.zip", (Get-Location).Path + "\website-code-M01-01.zip")
